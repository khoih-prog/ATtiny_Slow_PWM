...
#ifndef AT_TINY_SLOW_PWM_IMPL_H
#define AT_TINY_SLOW_PWM_IMPL_H
...
// Assuming Clock is 16MHz
#if USING_FULL_CLOCK
  // Use no prescaler (prescaler 1) => 20/16MHz, etc.
  #if (_PWM_LOGLEVEL_ > 2)
    #warning Using no prescaler => FULL_CLOCK (20MHz, 16MHz, etc)
  #endif
  ...
  #if (_PWM_LOGLEVEL_ > 2)
    #warning Using prescaler 2 => HALF_CLOCK (10MHz, 8MHz, etc.)
  #endif

  #define TCB_CLKSEL_VALUE      TCB_CLKSEL_DIV2_gc
  #define CLOCK_PRESCALER       2

  // No TCB_CLKSEL_CLKTCA_gc in megaTinyCore ???
