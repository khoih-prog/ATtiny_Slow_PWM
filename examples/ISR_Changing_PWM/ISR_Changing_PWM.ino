...
void loop()
{
  Serial.print(F("PWM Freq = ")); Serial.print(PWM_Freq1); 
  Serial.print(F(", DC = ")); Serial.println(PWM_DutyCycle1);
  ...
  Serial.print(F("PWM Freq = ")); Serial.print(PWM_Freq2); Serial.print(F(", DC = ")); Serial.println(PWM_DutyCycle2);
